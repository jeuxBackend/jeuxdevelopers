<nav class="navbar navbar-expand-lg navbar-light bg-light mx-lg-4 mx-md-4 mx-2 py-3">
    <div class="container-fluid">
        <a class="navbar-brand p-0" href="#">
            <img src="{{ asset('assets/images/logo/logo.png') }}" alt="" width="100px" class="ms-3">
        </a>
        <button class="navbar-toggler border-0 shadow-none outline-0" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"
            aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <span class="fa fa-solid fa-bars nav-burger text-dark-orange"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="contact-btns">
                <a href="#!" class="btn call-btn px-4 border-0 shadow-none me-2 mt-lg-0 mt-2">Call</a>
                {{-- <a href="#!" class="btn  px-2 rounded-pill border-0 shadow-none">WHATSAPP</a> --}}
                <a href="#!"
                class="btn whatsapp-btn d-inline-flex px-3 align-items-center shadow-none d-inline rounded-pill me-2 mt-lg-0 mt-2">
                <img src="{{ asset('assets/images/icons/whatsapp-icon.png') }}" width="25px" class="me-2" alt="">
                WHATSAPP
            </a>
                <a href="#!" class="btn contact-btn px-4 border-0 shadow-none mt-lg-0 mt-2">CONTACTUS</a>
            </div>
        </div>
    </div>
</nav>
